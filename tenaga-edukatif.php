...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Tenaga Edukatif</title>
...
<body>
    ...
    $tenagaEdukatif = [
        ['nama' => 'Hasan Bukhori, S.Pd', 'nip' => '197601262006041002', 'alamat' => 'Trikarso Struweng'],
        ['nama' => 'Drs. Rakiman', 'nip' => '196902111995011001', 'alamat' => 'Kamulyan Kuwarasan Kebumen'],
        ['nama' => 'Yanei Wardiyanti, S.Pd', 'nip' => '197106021998022004', 'alamat' => 'Kuwarasan'],
        ['nama' => 'Muju Utami, S.Pd', 'nip' => '196904241998022002', 'alamat' => 'Kuwarasan'],
        ['nama' => 'Irwan Slamet Warsito', 'nip' => '197905112008011015', 'alamat' => 'Jatinegara RT 3 Rw 4, Kec. Sempor Kab. Kebumen'],
        ['nama' => 'Nurhikmawati Satmi, S.Pd', 'nip' => '196707302005012004', 'alamat' => 'Selang Kebumen'],
        ['nama' => 'Eny Setiowati, S.Pd', 'nip' => '197011262008012006', 'alamat' => 'Karanganyar, Kebumen'],
        ['nama' => 'Supriyanto, S.Pd', 'nip' => '197203092006041013', 'alamat' => 'Semanding Gombong Kebumen'],
        ['nama' => 'Supini', 'nip' => '196812292008012017', 'alamat' => 'Adimulyo'],
        ['nama' => 'Sumisiyah, S.Pd', 'nip' => '197509022008012014', 'alamat' => 'Kuwarasan'],
        ['nama' => 'Dwi Astuti, S.Pd', 'nip' => '197611242008012013', 'alamat' => 'Sikayu Buayan'],
        ['nama' => 'Lylys Leidiana Timur, S.Pd', 'nip' => '198012092008012016', 'alamat' => ''],
        ['nama' => 'Yusuf Sulaiman, S.Pd', 'nip' => '196708152005021002', 'alamat' => 'Gombong'],
        ['nama' => 'Sarpingi, S.Pd', 'nip' => '196803192008011009', 'alamat' => 'Kuwarasan'],
    ];
    ?>
    ...
    <div class="flex flex-col bg-white">
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <!-- ============================================ -->
                <!-- HALAMAN TENAGA EDUKATIF -->
                <!-- ============================================ -->
                <div class="bg-[#EAF1F4] pb-12">
                    
                    <!-- Judul TENAGA EDUKATIF (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">TENAGA EDUKATIF</h1>
                    </div>
                    ...
                    <div class="max-w-6xl mx-auto px-4 mt-10">
                        ...
                        <div class="flex justify-end mb-6">
                            <div class="relative">
                                ...
                                <input type="text" id="searchInput" class="search-input pl-9" placeholder="Cari nama atau NIP..." onkeyup="searchTable()">
                            </div>
                        </div>
                        ...
                        <div class="table-container bg-white rounded-2xl shadow-lg overflow-hidden">
                            <table class="teacher-table w-full">
                                ...
                                <tbody id="tableBody">
                                    <?php foreach($tenagaEdukatif as $index => $guru): ?>
                                    <tr class="teacher-row">
                                        <td class="text-center"><?= $index + 1 ?></td>
                                        <td class="font-medium"><?= htmlspecialchars($guru['nama']) ?></td>
                        ...
                        <div class="mt-4 text-right text-[#636566] text-sm" style="font-family: 'Inria Serif', serif;">
                            Total Tenaga Edukatif: <span id="totalCount"><?= count($tenagaEdukatif) ?></span> orang
                        </div>
                    </div>
    ...
    <script>
        ...
        function searchTable() {
            ...
            const rows = document.querySelectorAll('#tableBody .teacher-row');
            let visibleCount = 0;
