...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Prestasi Sekolah</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .prestasi-table { min-width: 900px; }
        }
        ...
        .prestasi-table th.text-left { text-align: left; }
        .prestasi-table td {
            padding: 10px 14px; border-bottom: 1px solid #e5e5e5;
            color: #333434; font-size: 13px; text-align: center; vertical-align: middle;
            font-family: 'Inria Serif', serif;
        }
        .prestasi-table td.text-left { text-align: left; }
        .prestasi-table tbody tr:hover td { background-color: #f0f8ff; }

        /* Badge tingkat (tetap ada untuk filter tapi tidak digunakan karena data kosong) */
        .badge {
            display: inline-block; padding: 3px 10px; border-radius: 20px;
            font-size: 11px; font-weight: 700; white-space: nowrap;
        }
        .badge-kab  { background: #dbeafe; color: #1d4ed8; }
        .badge-prov { background: #d1fae5; color: #065f46; }
        .badge-nas  { background: #fef3c7; color: #92400e; }
            ...
            <div class="self-stretch">
                ...
                <div class="nav-menu-mobile" id="navMenuMobile">
                    ...
                    <div class="mobile-dropdown active">
                        ...
                        <div class="mobile-dropdown-content">
                            <a href="prestasi-sekolah.php" style="color:#0090EA;font-weight:600;">Prestasi Sekolah</a>
                            <a href="prestasi-siswa.php">Prestasi Siswa</a><a href="prestasi-guru.php">Prestasi Guru</a>
                        </div>
                    </div>
                    <div class="mobile-dropdown">
                ...
                <!-- ============ HALAMAN PRESTASI SEKOLAH (TABEL KOSONG) ============ -->
                <div class="bg-[#EAF1F4] pb-12">

                    <!-- Judul PRESTASI SEKOLAH ukuran 4xl (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">PRESTASI SEKOLAH</h1>
                    </div>
                    ...
                    <div class="max-w-6xl mx-auto px-4 mt-10">
                        ...
                        <div class="table-container bg-white rounded-2xl shadow-lg overflow-hidden">
                            <table class="prestasi-table">
                                ...
                                <tbody>
                                    <tr class="empty-row">
                                        <td colspan="12" style="text-align: center; padding: 40px 20px; font-family: 'Inria Serif', serif;">
                                            <i class="fa-regular fa-trophy text-3xl mb-2 block text-[#0090EA]"></i>
                                            Belum ada data prestasi sekolah.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
