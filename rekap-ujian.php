...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Rekap Ujian Sekolah</title>
    ...
    <style>
        * {
        ...
        /* Table styles - disesuaikan dengan gambar (kolom TAHUN PELAJARAN, MATA PELAJARAN, TERTINGGI, TERENDAH, RATA-RATA) */
        .exam-table th {
            background-color: #0090EA;
            color: white;
            padding: 12px 16px;
        ...
        /* Custom select - tetap menggunakan font Inria Serif */
        .tahun-select {
            background-color: white;
    ...
    <div class="flex flex-col bg-white">
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <!-- ============================================ -->
                <!-- HALAMAN REKAP UJIAN SEKOLAH (Font Inria Serif, judul 4xl, tabel sesuai gambar dengan isi kosong) -->
                <!-- ============================================ -->
                <div class="bg-[#EAF1F4] pb-12">
                    
                    <!-- Judul REKAP UJIAN SEKOLAH ukuran 4xl (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">REKAP UJIAN SEKOLAH</h1>
                    </div>
                    ...
                    <div class="max-w-5xl mx-auto px-4 mt-10">
                        ...
                        <!-- Filter Tahun Pelajaran dengan FORM GET (tetap ada untuk konsistensi, tapi tidak mengubah isi tabel) -->
                        <div class="flex justify-end mb-6">
                            <form method="GET" action="" class="inline-block">
                                <label class="text-[#636566] text-sm mr-2" style="font-family: 'Inria Serif', serif;">Tahun Pelajaran:</label>
                        ...
                        <!-- Tabel Rekap Ujian dengan kolom sesuai gambar: TAHUN PELAJARAN | MATA PELAJARAN | TERTINGGI | TERENDAH | RATA-RATA -->
                        <!-- SEMUA ISI TABEL DIKOSONGKAN (hanya garis pemisah) -->
                        <div class="table-container bg-white rounded-2xl shadow-lg overflow-hidden">
                            <table class="exam-table w-full">
                                <thead>
                                    <tr>
                                        <th class="w-1/4" style="font-family: 'Inria Serif', serif;">TAHUN PELAJARAN</th>
                                        <th class="w-2/5" style="font-family: 'Inria Serif', serif;">MATA PELAJARAN</th>
                                        <th class="w-1/5 text-center" style="font-family: 'Inria Serif', serif;">TERTINGGI</th>
                                        <th class="w-1/5 text-center" style="font-family: 'Inria Serif', serif;">TERENDAH</th>
                                        <th class="w-1/5 text-center" style="font-family: 'Inria Serif', serif;">RATA-RATA</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- Baris kosong (tidak ada data) sesuai permintaan -->
                                    <tr>
                                        <td class="text-center text-[#636566] py-6" colspan="5" style="font-family: 'Inria Serif', serif;">
                                            <i class="fa-regular fa-folder-open text-2xl mb-2 block"></i>
                                            Belum tersedia data rekap ujian
                                        </td>
                                    </tr>
                                    <!-- Contoh baris kosong seperti format di gambar, namun tetap kosong -->
                                </tbody>
                                <!-- Tidak ada foot/total karena data kosong -->
                             </table>
                        </div>
