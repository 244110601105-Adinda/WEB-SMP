...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Profil Sekolah</title>
        ...
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <div class="bg-[#EAF1F4] pb-12">
                    ...
                    <!-- Judul PROFIL SEKOLAH (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">PROFIL SEKOLAH</h1>
                    </div>
                    ...
                    <div class="max-w-5xl mx-auto px-4 mt-10">
                        ...
                        <!-- Gambar Sekolah (agak full, masih ada jarak dari tepi) -->
                        <div class="mb-8 rounded-2xl overflow-hidden shadow-lg mx-0 md:mx-4">
                            <img src="https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/962d68b2-2f7e-4a45-b0d8-af2e6430e429" 
                                 alt="Gambar Sekolah SMP Negeri 1 Buayan"
                                 class="w-full h-80 md:h-[450px] object-cover hover:scale-105 transition duration-500">
                        </div>
                        
                        <!-- Card Informasi Sekolah (ukuran sama dengan gambar) -->
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden mx-0 md:mx-4">
                            <div class="bg-gradient-to-r from-[#0090EA] to-[#005184] px-6 py-4">
                                <h2 class="text-white text-xl font-bold flex items-center gap-2" style="font-family: 'Inria Serif', serif;">
                                    <span>📋</span> Data Sekolah SMP Negeri 1 Buayan
                                </h2>
                            </div>
                            <div class="p-6">
                                <div class="space-y-4">
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Nama Sekolah</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: SMP Negeri 1 Buayan</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Alamat</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: Jl. Karangbolong, Kec. Buayan, Kab. Kebumen</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Email</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: smpnbuayan01@gmail.com</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Telp</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: (0287) 4760162</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Whatsapp</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: 088238063441</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Akreditasi</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: A</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Kurikulum</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: Merdeka</div>
                                    </div>
                                    <div class="flex flex-wrap border-b border-gray-100 pb-3">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Kepala Sekolah</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: Hasan Bukhori, S.Pd</div>
                                    </div>
                                    <div class="flex flex-wrap">
                                        <div class="w-44 text-[#636566] text-sm font-semibold" style="font-family: 'Inria Serif', serif;">Operator</div>
                                        <div class="flex-1 text-[#333434] text-sm" style="font-family: 'Inria Serif', serif;">: Irwan Slamet Warsito, S.Si, M.Pd</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="self-stretch py-6 gradient-blue-vertical">
                    <div class="flex items-start self-stretch mb-8 ml-4 md:ml-8 mr-4 md:mr-8 footer-content flex-wrap">
                        ...
                        <div class="flex flex-col shrink-0 items-start mt-4 md:mt-0 gap-2 w-full md:w-auto">
                            ...
                            <div class="flex items-center gap-2">
                                <button onclick="showToast('Facebook')" class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">Facebook</button>
                                <button onclick="showToast('Instagram')" class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">Instagram</button>
                                <button onclick="showToast('Twitter')" class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">Twitter</button>
                            </div>
                        </div>
                    </div>
