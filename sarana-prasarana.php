...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Sarana Prasarana</title>
        ...
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <div class="bg-[#EAF1F4] pb-12">
                    ...
                    <!-- Judul SARANA PRASARANA (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">SARANA PRASARANA</h1>
                    </div>
                    ...
                    <!-- Konten Link Google Drive -->
                    <div class="max-w-3xl mx-auto px-4 mt-10">
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden drive-card">
                            <div class="bg-gradient-to-r from-[#0090EA] to-[#005184] px-6 py-4">
                                <h2 class="text-white text-xl font-bold flex items-center gap-2" style="font-family: 'Inria Serif', serif;">
                                    <i class="fa-brands fa-google-drive"></i> Dokumen Sarana Prasarana
                                </h2>
                            </div>
                            <div class="p-8 text-center">
                                <!-- Icon -->
                                <div class="mb-6">
                                    <div class="w-24 h-24 bg-[#EAF1F4] rounded-full flex items-center justify-center mx-auto">
                                        <i class="fa-brands fa-google-drive text-5xl text-[#0090EA]"></i>
                                    </div>
                                </div>
                                
                                <!-- Teks -->
                                <h3 class="text-[#333434] text-xl font-bold mb-3" style="font-family: 'Inria Serif', serif;">
                                    Data Sarana dan Prasarana SMP Negeri 1 Buayan
                                </h3>
                                <p class="text-[#636566] text-sm mb-6" style="font-family: 'Inria Serif', serif;">
                                    Klik link di bawah untuk mengakses dokumen lengkap data sarana dan prasarana sekolah.
                                </p>
                                
                                <!-- Teks Link (bukan tombol) -->
                                <div class="mb-6">
                                    <a href="https://drive.google.com/file/d/16wL19wKRJzhhtgbYok9f7H_wQpPvM0An/view?usp=sharing" 
                                       target="_blank"
                                       class="text-[#0090EA] hover:text-[#005184] underline text-base font-semibold transition" 
                                       style="font-family: 'Inria Serif', serif;">
                                        <i class="fa-regular fa-file-lines mr-2"></i> 
                                        Klik di sini untuk melihat dokumen Sarana Prasarana
                                    </a>
                                </div>
