...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Kalender Akademik</title>
    ...
    <style>
        * {
        ...
        /* Calendar styles (tetap, tidak ada perubahan isi konten) */
        .calendar-card {
            transition: all 0.3s ease;
        }
    ...
    <div class="flex flex-col bg-white">
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <!-- ============================================ -->
                <!-- HALAMAN KALENDER AKADEMIK (konten dihapus/dikosongkan) -->
                <!-- ============================================ -->
                <div class="bg-[#EAF1F4] pb-12">
                    
                    <!-- Judul KALENDER AKADEMIK ukuran 4xl (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">KALENDER AKADEMIK</h1>
                    </div>
                    ...
                    <!-- KOSONGKAN SEMUA KONTEN KALENDER AKADEMIK (hanya tampilan minimal) -->
                    <div class="max-w-5xl mx-auto px-4 mt-10">
                        <!-- Pilih Tahun Pelajaran (tetap ada untuk struktur, tanpa isi list) -->
                        <div class="flex justify-end mb-6">
                            <div class="inline-flex rounded-lg overflow-hidden border border-gray-200 bg-white">
                                <button class="px-4 py-2 text-sm font-medium bg-[#0090EA] text-white" style="font-family: 'Inria Serif', serif;">2025/2026</button>
                                <button class="px-4 py-2 text-sm font-medium text-[#333434] hover:bg-gray-100" style="font-family: 'Inria Serif', serif;">2026/2027</button>
                            </div>
                        </div>
                        
                        <!-- Card Kalender - Semester 1 (DIKOSONGKAN) -->
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden calendar-card mb-8">
                            <div class="month-header px-6 py-4">
                                <h2 class="text-white text-xl font-bold flex items-center gap-2" style="font-family: 'Inria Serif', serif;">
                                    <i class="fa-solid fa-calendar-alt"></i> Semester Ganjil
                                </h2>
                            </div>
                            <div class="p-6">
                                <!-- KOSONG: tidak ada konten agenda/bulan -->
                                <div class="text-center py-8 text-[#636566] text-sm" style="font-family: 'Inria Serif', serif;">
                                    <i class="fa-regular fa-calendar-xmark text-3xl mb-2 block"></i>
                                    Belum tersedia agenda untuk semester ini.
                                </div>
                            </div>
                        </div>
                        
                        <!-- Card Kalender - Semester 2 (DIKOSONGKAN) -->
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden calendar-card">
                            <div class="month-header px-6 py-4">
                                <h2 class="text-white text-xl font-bold flex items-center gap-2" style="font-family: 'Inria Serif', serif;">
                                    <i class="fa-solid fa-calendar-alt"></i> Semester Genap
                                </h2>
                            </div>
                            <div class="p-6">
                                <!-- KOSONG: tidak ada konten agenda/bulan -->
