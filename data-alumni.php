...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Data Alumni</title>
...
<body>
    <div class="flex flex-col bg-white">
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <!-- ============================================ -->
                <!-- HALAMAN DATA ALUMNI (TABEL KOSONG) -->
                <!-- ============================================ -->
                <div class="bg-[#EAF1F4] pb-12">
                    
                    <!-- Judul DATA ALUMNI ukuran 4xl (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">DATA ALUMNI</h1>
                    </div>
                    ...
                    <!-- Tabel Data Alumni (KOSONG) -->
                    <div class="max-w-5xl mx-auto px-4 mt-10">
                        <!-- Search Box (tetap ada untuk UI) -->
                        <div class="flex justify-end mb-6">
                            <div class="relative">
                                <i class="fa-solid fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-[#636566] text-sm"></i>
                                <input type="text" id="searchInput" class="search-input pl-9" placeholder="Cari tahun pelajaran..." onkeyup="searchTable()" disabled style="background-color:#f5f5f5; cursor:not-allowed;">
                            </div>
                        </div>
                            ...
                            <table class="alumni-table w-full">
                                ...
                                <tbody id="tableBody">
                                    <tr class="empty-row">
                                        <td colspan="5" style="text-align: center; padding: 40px 20px;">
                                            <i class="fa-regular fa-folder-open text-3xl mb-2 block text-[#0090EA]"></i>
                                ...
                                <tfoot class="bg-gray-100 font-bold">
                                    <tr>
                                        ...
                                        <td class="text-center text-blue-600">0 Jiwa</td>
                                        <td class="text-center text-blue-600">0 Jiwa</td>
                                        <td class="text-center text-blue-600">0 Jiwa</td>
                                    </tr>
                                </tfoot>
                        ...
                        <div class="mt-4 text-right text-[#636566] text-sm" style="font-family: 'Inria Serif', serif;">
                            Total Data Tahun Pelajaran: <span id="totalCount">0</span> tahun
                        </div>
                    </div>
    ...
    <script>
        ...
        // ============================================
        // SEARCH FUNCTION (tetap ada meskipun data kosong)
        // ============================================
        function searchTable() {
            const input = document.getElementById('searchInput');
            const filter = input.value.toLowerCase();
            const rows = document.querySelectorAll('#tableBody .alumni-row');
            let visibleCount = 0;
            
            rows.forEach(row => {
                if (row.cells && row.cells[1]) {
                    const tahun = row.cells[1].textContent.toLowerCase();
                    if (tahun.includes(filter)) {
                        row.style.display = '';
                        visibleCount++;
                    } else {
