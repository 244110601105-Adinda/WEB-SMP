...
<head>
  ...
  <title>SMP Negeri 1 Buayan - Struktur Organisasi</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .gradient-blue { background: linear-gradient(180deg, #0090EA, #005184); }
    ...
    @media (max-width: 768px) {
      ...
      .footer-content .ml-8 { margin-left: 0 !important; }
    }
...
<body class="min-h-screen flex flex-col">
      ...
      <div class="self-stretch">
        ...
        <div class="bg-[#EAF1F4] pb-12">
          ...
          <div class="text-center pt-8 pb-4">
            <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">STRUKTUR ORGANISASI</h1>
          </div>
          ...
          <div class="max-w-5xl mx-auto px-4 mt-10">
            <div class="org-diagram-wrap">
              <div class="flex items-center justify-between flex-wrap gap-3 mb-4">
                <div class="flex items-center gap-2">
                  <span class="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-r from-[#0090EA] to-[#005184] text-white">
                    <i class="fa-solid fa-sitemap"></i>
                  </span>
                  <h2 class="text-[#333434] font-bold text-lg md:text-xl" style="font-family: 'Inria Serif', serif;">Bagan Struktur SMP Negeri 1 Buayan</h2>
                </div>
              </div>

              <!-- Diagram -->
              <div class="rounded-2xl overflow-hidden bg-white/70">
                <img
                  class="org-diagram-img"
                  src="assets/strukturOrganisasi.jpg"
                  alt="Struktur Organisasi SMP Negeri 1 Buayan"
                  onerror="this.src='https://placehold.co/1000x700/0090EA/white?text=Struktur+Organisasi'"
                />
              </div>
            </div>
          </div>
        ...
        <!-- ============================================ -->
        <!-- FOOTER (SAMA PERSIS KAYA DI HALAMAN HOME) -->
        <!-- ============================================ -->
        <div class="self-stretch py-6 gradient-blue-vertical">
          <div class="flex items-start self-stretch mb-8 ml-4 md:ml-8 mr-4 md:mr-8 footer-content flex-wrap">
            ...
            <div class="flex flex-col shrink-0 items-start mt-4 md:mt-0 gap-2 w-full md:w-auto">
              ...
              <div class="flex items-center gap-2">
                <button onclick="showToast('Membuka Facebook')"
                        class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">
                  Facebook
                </button>
                <button onclick="showToast('Membuka Instagram')"
                        class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">
                  Instagram
                </button>
                <button onclick="showToast('Membuka Twitter')"
                        class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">
                  Twitter
                </button>
                <button onclick="showToast('Membuka YouTube')"
                        class="bg-white/20 px-3 py-1 rounded-lg text-white text-xs hover:bg-white/30" style="font-family: 'Inria Serif', serif;">
                  YouTube
                </button>
              </div>
          ...
          <div class="flex flex-col items-center self-stretch">
            <span class="text-white text-xs font-bold text-center px-4" style="font-family: 'Inria Serif', serif;">
              Copyright © 2021 - <?= date('Y') ?> SMP NEGERI 1 BUAYAN
            </span>
          </div>
        </div>
  ...
  <script>
    ...
    // Animasi fade-in + tutup menu saat klik link mobile
