...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Visi & Misi</title>
        ...
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <div class="bg-[#EAF1F4] pb-12">
                    ...
                    <!-- Judul VISI DAN MISI (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">VISI DAN MISI</h1>
                    </div>
                    ...
                    <div class="max-w-5xl mx-auto px-4 mt-10">
                        ...
                        <!-- CARD VISI (desain seperti card sejarah: border bottom) -->
                        <div class="bg-white rounded-2xl shadow-md overflow-hidden visi-card hover-lift mb-8">
                            <div class="border-b border-gray-200 px-6 py-4">
                                <h2 class="text-[#333434] text-xl font-bold flex items-center gap-2" style="font-family: 'Inria Serif', serif;">
                                    <i class="fa-solid fa-eye text-[#0090EA]"></i> VISI
                                </h2>
                            </div>
                            <div class="p-6">
                                <p class="text-[#0090EA] text-lg font-semibold mb-4 text-center italic" style="font-family: 'Inria Serif', serif;">
                                    "Unggul dalam Mutu, Terampil, Santun dalam Perilaku, Berwawasan Lingkungan, Berdasarkan Iman dan Taqwa"
                                </p>
                                <div class="text-[#636566] text-sm leading-relaxed space-y-3" style="font-family: 'Inria Serif', serif;">
                                    <p>
                                        Visi "Unggul dalam Mutu, Terampil, Santun dalam Perilaku, Berwawasan Lingkungan, Berdasarkan Iman dan Taqwa" merupakan salah satu cita-cita SMP Negeri 1 Buayan dalam menyediakan pendidikan yang holistik, berkualitas, dan relevan dengan perkembangan zaman. Visi ini menjadi wajib komitmen setiap orang untuk mencapai prestasi yang tidak hanya unggul secara akademik, tetapi juga memiliki moral, sosial, dan spiritual yang baik.
                                    </p>
                                    <p>
                                        Unggul dalam mutu berarti selalu terus berupaya meningkatkan kualitas pembelajaran, pengelolaan pendidikan, serta prestasi peserta didik di bidang akademik maupun non-akademik. Proses pembelajaran ditawarkan aktif, kreatif, dan bermakna agar peserta didik dapat berkembang secara optimal sesuai bakat dan minatnya.
                                    </p>
                                    <p>
                                        Terampil memberikan kemampuan peserta didik dalam menerapkan pengetahuan di kehidupan sehari-hari. Sekolah mendampingi penggunaan keterampilan abad 21, seperti berpikir kritis, kreatif, kolaborasi, dan komunikatif, serta keterampilan hidup (life skills) agar peserta didik mampu beradaptasi dan aktif terhadap perkembangan ilmu pengetahuan dan teknologi.
                                    </p>
                                    <p>
                                        Sekolah juga memberikan peran untuk siswa mengembangkan nilai sikap santun, kejujuran, disiplin, tanggung jawab, serta sikap yang mengarahkan siswa untuk melaksanakan tugas yang sesuai dengan lingkungan yang umum dan beretika.
                                    </p>
                                </div>
                            </div>
                        </div>
                        
                        <!-- CARD MISI (desain seperti card sejarah: border bottom) -->
                        <div class="bg-white rounded-2xl shadow-md overflow-hidden misi-card hover-lift">
                            <div class="border-b border-gray-200 px-6 py-4">
                                <h2 class="text-[#333434] text-xl font-bold flex items-center gap-2" style="font-family: 'Inria Serif', serif;">
                                    <i class="fa-solid fa-bullseye text-[#0090EA]"></i> MISI
                                </h2>
                            </div>
                            <div class="p-6">
                                <ul class="misi-list space-y-3" style="font-family: 'Inria Serif', serif;">
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">1.</span>
                                        <span>Meningkatkan kualitas pembelajaran yang aktif, kreatif, inovatif, efektif, dan menyenangkan (PAKEM) untuk mencapai prestasi akademik yang optimal.</span>
                                    </li>
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">2.</span>
                                        <span>Mengembangkan potensi peserta didik secara optimal melalui kegiatan intrakurikuler dan ekstrakurikuler yang beragam dan berkualitas.</span>
                                    </li>
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">3.</span>
                                        <span>Membentuk karakter peserta didik yang santun, jujur, disiplin, bertanggung jawab, dan berakhlak mulia melalui pembiasaan dan keteladanan.</span>
                                    </li>
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">4.</span>
                                        <span>Mewujudkan sekolah yang berwawasan lingkungan dengan menerapkan budaya bersih, hijau, dan berkelanjutan.</span>
                                    </li>
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">5.</span>
                                        <span>Meningkatkan iman dan taqwa melalui kegiatan keagamaan yang rutin dan terprogram, serta pengamalan nilai-nilai keagamaan dalam kehidupan sehari-hari.</span>
                                    </li>
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">6.</span>
                                        <span>Meningkatkan profesionalisme pendidik dan tenaga kependidikan melalui pelatihan dan pengembangan kompetensi berkelanjutan.</span>
                                    </li>
                                    <li class="flex items-start gap-3 text-[#636566] text-sm leading-relaxed">
                                        <span class="text-[#0090EA] font-bold mt-1">7.</span>
                                        <span>Menjalin kerjasama yang harmonis dengan orang tua, masyarakat, dan stakeholders dalam rangka mendukung peningkatan mutu pendidikan.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
