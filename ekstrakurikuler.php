...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Ekstrakurikuler</title>
...
<body>
    <?php
    // DATA EKSTRAKURIKULER - GANTI DENGAN GAMBAR YANG ANDA PUNYA
    // Simpan gambar di folder "images" dan sesuaikan nama filenya
    $eskulList = [
        ['nama' => 'TARI', 'gambar' => 'https://www.smpn1buayan.sch.id/assets/img/foto/84f4388bb794fb727d154224c4f4e836.jpeg'],
        ['nama' => 'PMR', 'gambar' => 'assets/pmr.jpeg'],
        ['nama' => 'PRAMUKA', 'gambar' => 'https://www.smpn1buayan.sch.id/assets/img/foto/51cdc67f3d7cb5f960f19730311d25e2.jpeg'],
        ['nama' => 'OLAHRAGA', 'gambar' => 'https://www.smpn1buayan.sch.id/assets/img/foto/04028de3efd05360e630160c3bbb837a.jpg'],
        ['nama' => 'DRUMBAND', 'gambar' => 'assets/drumband.jpeg'],
        ['nama' => 'ENGLISH CLUB', 'gambar' => 'https://www.smpn1buayan.sch.id/assets/img/foto/0ca6080e0d53e832c9ce3d901111e4e4.jpg'],
        ['nama' => 'SPENSABU SAINS CLUB', 'gambar' => 'https://www.smpn1buayan.sch.id/assets/img/foto/a12718f71e0bf26c48a3a9dde896f23c.jpg'],
    ];
    ?>
    ...
    <div class="flex flex-col bg-white">
        <div class="flex flex-col items-start self-stretch bg-[#EAF1F4]">
            <div class="self-stretch">
                ...
                <!-- ============================================ -->
                <!-- HALAMAN EKSTRAKURIKULER (Font Inria Serif, judul 4xl) -->
                <!-- ============================================ -->
                <div class="bg-[#EAF1F4] pb-12">
                    
                    <!-- Judul EKSTRAKURIKULER ukuran 4xl (text-4xl) -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">EKSTRAKURIKULER</h1>
                    </div>
                    ...
                    <!-- Daftar Ekstrakurikuler dalam Grid (tidak ada perubahan) -->
                    <div class="max-w-6xl mx-auto px-4 mt-10">
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 eskul-grid">
                            <?php foreach($eskulList as $eskul): ?>
                            <div class="bg-white rounded-xl shadow-md overflow-hidden eskul-card cursor-pointer">
                                <img src="<?= $eskul['gambar'] ?>" 
                                     alt="<?= $eskul['nama'] ?>"
                                     class="eskul-image"
                                     onerror="this.src='https://placehold.co/500x300/0090EA/white?text=<?= urlencode($eskul['nama']) ?>'">
                                <div class="p-4 text-center">
                                    <h3 class="text-[#333434] font-bold text-sm md:text-base" style="font-family: 'Inria Serif', serif;"><?= $eskul['nama'] ?></h3>
                                </div>
                            </div>
                            <?php endforeach; ?>
                        </div>
