...
<head>
    ...
    <title>SMP Negeri 1 Buayan - Struktur Kurikulum</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <!-- Google Fonts - Inria Serif (wajib sesuai permintaan) -->
    ...
    <style>
        * {
        ...
        /* ========== DROPDOWN MENU STYLES (sama persis seperti halaman home dengan icon chevron) ========== */
        .dropdown {
            position: relative;
        ...
        /* icon chevron untuk mobile sama seperti home ( ▼ dan ▲ ) */
...
<body>
            ...
            <div class="self-stretch">
                ...
                <div class="bg-white shadow-sm">
                    <div class="desktop-nav">
                        ...
                        <!-- Desktop Navigation Menu dengan Dropdown icon chevron (mirip home) -->
                        <div class="nav-menu-desktop">
                            <a href="home.php" style="font-family: 'Inria Serif', serif;">Home</a>
                            
                            <!-- Dropdown Berita -->
                            <div class="dropdown">
                                <button class="dropbtn" onclick="toggleDropdown(event, this)" style="font-family: 'Inria Serif', serif;">
                ...
                <!-- Mobile Navigation Menu dengan Dropdown Accordion (chevron style seperti home) -->
                ...
                <!-- ============================================ -->
                <!-- HALAMAN STRUKTUR KURIKULUM (Font Inria Serif, judul text-4xl) -->
                <!-- ============================================ -->
                <div class="bg-[#EAF1F4] pb-12">
                    
                    <!-- Judul STRUKTUR KURIKULUM ukuran 4xl (text-4xl) sesuai permintaan -->
                    <div class="text-center pt-8 pb-4">
                        <h1 class="text-[#333434] text-4xl font-bold tracking-wider" style="font-family: 'Inria Serif', serif;">STRUKTUR KURIKULUM</h1>
                    </div>
                    ...
                    <div class="max-w-4xl mx-auto px-4 mt-10">
                        <div class="table-container bg-white rounded-2xl shadow-lg overflow-hidden">
                            <table class="curriculum-table w-full">
                                <thead>
                                    <tr>
                                        <th class="w-2/3" style="font-family: 'Inria Serif', serif;">MATA PELAJARAN</th>
                                        <th class="w-1/3 text-center" style="font-family: 'Inria Serif', serif;">ALOKASI WAKTU (JP/Tahun)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <!-- Kelompok A -->
                                    <tr class="group-header">
                                        <td colspan="2" class="font-bold text-[#0090EA]" style="font-family: 'Inria Serif', serif;">KELOMPOK A</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Pendidikan Agama dan Budi Pekerti</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">108</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Pendidikan Pancasila</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">108</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Bahasa Indonesia</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">216</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Matematika</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">180</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">IPA</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">180</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">IPS</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">144</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Bahasa Inggris</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">144</td>
                                    </tr>
                                    <tr class="total-row">
                                        <td class="font-bold" style="font-family: 'Inria Serif', serif;">JUMLAH</td>
                                        <td class="text-center font-bold" style="font-family: 'Inria Serif', serif;">1080</td>
                                    </tr>
                                    
                                    <!-- Kelompok B -->
                                    <tr class="group-header">
                                        <td colspan="2" class="font-bold text-[#0090EA]" style="font-family: 'Inria Serif', serif;">KELOMPOK B</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Seni Budaya</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">108</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">PJOK</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">108</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Informatika</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">108</td>
                                    </tr>
                                    <tr class="total-row">
                                        <td class="font-bold" style="font-family: 'Inria Serif', serif;">JUMLAH</td>
                                        <td class="text-center font-bold" style="font-family: 'Inria Serif', serif;">324</td>
                                    </tr>
                                    
                                    <!-- Kelompok C (Muatan Lokal) -->
                                    <tr class="group-header">
                                        <td colspan="2" class="font-bold text-[#0090EA]" style="font-family: 'Inria Serif', serif;">KELOMPOK C (Muatan Lokal)</td>
                                    </tr>
                                    <tr>
                                        <td style="font-family: 'Inria Serif', serif;">Bahasa Jawa</td>
                                        <td class="text-center" style="font-family: 'Inria Serif', serif;">72</td>
                                    </tr>
                                    <tr class="total-row">
                                        <td class="font-bold" style="font-family: 'Inria Serif', serif;">JUMLAH</td>
                                        <td class="text-center font-bold" style="font-family: 'Inria Serif', serif;">72</td>
                                    </tr>
                                    
                                    <!-- Total Keseluruhan -->
                                    <tr class="total-row" style="background-color: #0090EA; color: white;">
                                        <td class="font-bold" style="font-family: 'Inria Serif', serif;">TOTAL KESELURUHAN</td>
                                        <td class="text-center font-bold" style="font-family: 'Inria Serif', serif;">1476</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <script>
        ...
        // Animasi fade-in dan handling link mobile
